...
class GetStillagePageState extends StateMVC
{
  ...
  void _handleClick(String value) async
  {
    ...
    {
      case 'Изменить':
        Navigator.push(context, MaterialPageRoute(builder: (context) => PutStillagePage(id: _id)));
        break;
      case 'Удалить':
        ...
        if (value == true)
        {
          ...
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Стеллаж удален")));
