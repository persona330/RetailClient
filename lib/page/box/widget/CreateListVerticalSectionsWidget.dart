...
class CreateListVerticalSectionsWidget extends StatefulWidget
{
  const CreateListVerticalSectionsWidget({Key? key}) : super(key: key);

  @override
  _CreateListVerticalSectionsWidgetState createState() => _CreateListVerticalSectionsWidgetState();
}

class _CreateListVerticalSectionsWidgetState extends StateMVC
{
  late VerticalSectionsController _controller;
  late VerticalSections _verticalSections;

  _CreateListVerticalSectionsWidgetState() : super(VerticalSectionsController()) {_controller = controller as VerticalSectionsController;}
