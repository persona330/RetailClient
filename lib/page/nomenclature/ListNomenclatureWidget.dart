...
class ListNomenclatureWidget extends StatefulWidget
{
  const ListNomenclatureWidget({Key? key}) : super(key: key);

  @override
  _ListNomenclatureWidgetState createState() => _ListNomenclatureWidgetState();
}

class _ListNomenclatureWidgetState extends StateMVC
{
  late NomenclatureController _controller;
  late Nomenclature _nomenclature;

  _ListNomenclatureWidgetState() : super(NomenclatureController()) {_controller = controller as NomenclatureController;}
