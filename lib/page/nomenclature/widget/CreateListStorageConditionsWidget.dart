...
class CreateListStorageConditionsWidget extends StatefulWidget
{
  const CreateListStorageConditionsWidget({Key? key}) : super(key: key);

  @override
  _CreateListStorageConditionsWidgetState createState() => _CreateListStorageConditionsWidgetState();
}

class _CreateListStorageConditionsWidgetState extends StateMVC
{
  late StorageConditionsController _controller;
  late StorageConditions _storageConditions;

  _CreateListStorageConditionsWidgetState() : super(StorageConditionsController()) {_controller = controller as StorageConditionsController;}
    ...
    if (state is StorageConditionsResultLoading) {
      ...
      return DropdownButtonFormField(
          ...
          onChanged: (StorageConditions? item) {
            ...
            CreateNomenclaturePage.of(context)?.setStorageConditions(_storageConditions);
          }
      );
  }
  }
