...
class CreateListMeasurementHumidityWidget extends StatefulWidget
{
  const CreateListMeasurementHumidityWidget({Key? key}) : super(key: key);

  @override
  _CreateListMeasurementHumidityWidgetState createState() => _CreateListMeasurementHumidityWidgetState();
}

class _CreateListMeasurementHumidityWidgetState extends StateMVC
{
  late MeasurementController _controller;
  late Measurement _measurement;

  _CreateListMeasurementHumidityWidgetState() : super(MeasurementController()) {_controller = controller as MeasurementController;}
