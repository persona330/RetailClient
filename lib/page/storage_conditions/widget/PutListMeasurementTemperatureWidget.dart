...
class PutListMeasurementTemperatureWidget extends StatefulWidget
{
  const PutListMeasurementTemperatureWidget({Key? key}) : super(key: key);

  @override
  _PutListMeasurementTemperatureWidgetState createState() => _PutListMeasurementTemperatureWidgetState();
}

class _PutListMeasurementTemperatureWidgetState extends StateMVC
{
  late MeasurementController _controller;
  late Measurement _measurement;

  _PutListMeasurementTemperatureWidgetState() : super(MeasurementController()) {_controller = controller as MeasurementController;}
    ...
    if (state is MeasurementResultLoading) {
      ...
      return DropdownButtonFormField(
          ...
          onChanged: (Measurement? item) {
            ...
            PutStorageConditionsPage.of(context)?.setMeasurementTemperature(_measurement);
          }
      );
  }
  }
