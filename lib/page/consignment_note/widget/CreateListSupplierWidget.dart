...
class CreateListSupplierWidget extends StatefulWidget
{
  const CreateListSupplierWidget({Key? key}) : super(key: key);

  @override
  _CreateListSupplierWidgetState createState() => _CreateListSupplierWidgetState();
}

class _CreateListSupplierWidgetState extends StateMVC
{
  late SupplierController _controller;
  late Supplier _supplier;

  _CreateListSupplierWidgetState() : super(SupplierController()) {_controller = controller as SupplierController;}
