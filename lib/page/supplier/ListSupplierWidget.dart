...
import '../consignment_note/CreateConsignmentNotePage.dart';

class ListSupplierWidget extends StatefulWidget
{
  const ListSupplierWidget({Key? key}) : super(key: key);

  @override
  _ListSupplierWidgetState createState() => _ListSupplierWidgetState();
}

class _ListSupplierWidgetState extends StateMVC
{
  late SupplierController _controller;
  late Supplier _supplier;

  _ListSupplierWidgetState() : super(SupplierController()) {_controller = controller as SupplierController;}
