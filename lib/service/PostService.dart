...
class PostService
{
  ...
  final String _url1 = 'https://jsonplaceholder.typicode.com/posts/1';
  ...
  {
    final response = await http.post(Uri.parse(_url), headers: headers, body: json.encode(post.toJson()));
    //статус 201 - создан
